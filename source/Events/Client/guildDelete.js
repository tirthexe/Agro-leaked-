...
async function sendNotification(client, embed) {
  try {
    const webhook = new WebhookClient({ url: `https://discord.com/api/webhooks/1246792519178653787/m2J7sEcjQ3KnH2o-zJYc_PT527JGAmBWytK_NSxxhQML0mDaAFtv2VWlF2bDtCsCwkBa` });
